...
//             new SysIdRoutine.Config(Volts.per(Second).of(WristConstants.RAMP_RATE),
// Volts.of(WristConstants.STEP_VOLTAGE), null),
...
//                     .angularVelocity(
//                         m_velocity.mut_replace(inputs.angVelocityRadsPerSec,
// RotationsPerSecond));
...
//         Logger.recordOutput("PivotArm/PivotAbsoluteEncoderConnected", inputs.angleRads !=
// WristConstants.PIVOT_ARM_OFFSET);
//     }
...
//         this.setpoint = MathUtil.clamp(this.setpoint, WristConstants.PIVOT_ARM_MIN_ANGLE,
// WristConstants.PIVOT_ARM_MAX_ANGLE);
