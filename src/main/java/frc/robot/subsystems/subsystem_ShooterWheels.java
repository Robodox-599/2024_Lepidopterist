...
//         m_flywheel1 = new CANSparkMax(ShooterFlywheelConstants.MotorConstants.flywheel1ID,
//                 CANSparkLowLevel.MotorType.kBrushless);
//         m_flywheel2 = new CANSparkMax(ShooterFlywheelConstants.MotorConstants.flywheel2ID,
//                 CANSparkLowLevel.MotorType.kBrushless);
//         m_feeder = new CANSparkMax(ShooterFlywheelConstants.MotorConstants.feederID,
//                 CANSparkLowLevel.MotorType.kBrushless);
...
//         // m_wrist = new
//         // CANSparkMax(Constants.ShooterWristConstants.MotorConstants.wristID,CANSparkLowLevel.MotorType.kBrushless);
...
// public void setFlywheelsCommand(DoubleSupplier setpoint){
//     return this.runOnce(() -> set_flywheels(setpoint.getAsDouble()));
// }

//     public void toggle_feeder(boolean shoot) {

//         // if (!((m_feeder_go == true && shoot == true) || (m_feeder_go == false &&
//         // shoot ==false))){
//         m_feeder_go = shoot;
...
//     }
    ...
    // public Command startStopFeedersCommand() {
    //   //implicitly requires `this`
    //   return this.startEnd(() -> m_feeder_go = true, () -> m_feeder_go = false);
    // }

//     public boolean isWithinMargin(double margin) {
//         return ((Math.abs(m_flywheel2Encoder.getVelocity() -
//                 (m_desired_flywheel_speed
//                         - ShooterFlywheelConstants.differential)) <= margin)
//                 &&
//                 (Math.abs(m_flywheel1Encoder.getVelocity()
//                         - m_desired_flywheel_speed) <= margin));
//     }
...
//         SmartDashboard.putBoolean("wheels ok", isWithinMargin(ShooterFlywheelConstants.FlywheelMargin));
...
//         double voltageFeedforward2 = (m_Feedforward
//                 .calculate(m_desired_flywheel_speed - ShooterFlywheelConstants.differential))
//                 / SwerveConstants.kNominal;
...
//         // m_flywheel1PID.setReference(m_desired_flywheel_speed,
...
//         // if ((Math.abs(m_flywheel2Encoder.getVelocity() -
//         // (m_desired_flywheel_speed-ShooterFlywheelConstants.differential))
//         // > ShooterFlywheelConstants.FlywheelMargin)){
//         // // VelocityVoltage m_request = new VelocityVoltage(0).withSlot(0);
//         // if (m_desired_flywheel_speed-ShooterFlywheelConstants.differential>0){
//         // m_flywheel2PID.setReference(m_desired_flywheel_speed-ShooterFlywheelConstants.differential,CANSparkMax.ControlType.kVelocity,
//         // 0);
//         // }}
