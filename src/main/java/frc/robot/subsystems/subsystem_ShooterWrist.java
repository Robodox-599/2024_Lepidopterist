...
public class subsystem_ShooterWrist extends SubsystemBase {
  ...
  public subsystem_ShooterWrist() {
    ...
    m_wristEncoder = new Encoder(Constants.MotorConstants.DIO_pin1, Constants.MotorConstants.DIO_pin2);
  ...
  public void set_wrist(double angle) {
    ...
    m_desired_wrist_angle = angle * Constants.MotorConstants.rotations_to_angle;
  }

public boolean isWristAtDesiredPosition(){
  return Math.abs(m_wristEncoder.getRaw()*Constants.MotorConstants.ticks_to_rotations - m_desired_wrist_angle) 
  ...
  public void periodic() {
    ...
    // if (//encoder shit)
    if (!(Math.abs(m_wristEncoder.getRaw()*Constants.MotorConstants.ticks_to_rotations - m_desired_wrist_angle)>Constants.MotorConstants.wrist_margin)){
