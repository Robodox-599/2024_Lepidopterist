...
private final RelativeEncoder m_RelativeEncoder;
  ...
  public void set_wrist(double angle) {
    ...
    m_desired_wrist_angle = angle * Constants.ShooterWristConstants.MotorConstants.rotations_to_angle;
  }
...
public boolean isWristAtDesiredPosition(){
  ...
  // <= ShooterWristConstants.wristError;
    return Math.abs(m_RelativeEncoder.getPosition()*Constants.ShooterWristConstants.MotorConstants.rotations_to_angle - m_desired_wrist_angle) 
  <= ShooterWristConstants.wristError;
}
