...
public class SwerveModule {
    ...
    private final MutableMeasure<Angle> m_position = MutableMeasure.mutable(Radians.of(0));
    private final MutableMeasure<Velocity<Angle>> m_Velocity = MutableMeasure.mutable(RadiansPerSecond.of(0));
    ...
    public void setDriveVoltage(VoltageOut v){
        m_DriveMotor.setControl(v);
    }

    public void setTurnVoltage(VoltageOut v){
        m_AngleMotor.setControl(v);
    }
