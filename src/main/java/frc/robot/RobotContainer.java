...
public class RobotContainer {
  ...
  private final subsystem_Amper m_amper = new subsystem_Amper();
...
// y is stow
      ...
      m_driverController.y().whileTrue(command_cGroup_shooter.scoreAmp(m_flywheels, m_amper));
      m_driverController.y().onFalse(command_cGroup_shooter.endAmp(m_flywheels, m_amper));
  }
