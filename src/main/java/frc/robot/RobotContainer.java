...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_Shooter.setDefaultCommand(new command_ToWristAndSpeed(m_Shooter,()-> ShooterConstants.minNetAngle, () -> ShooterConstants.AmpSpeed));
  }
