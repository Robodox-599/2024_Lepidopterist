...
public class command_ToSetWrist extends Command {
  ...
  public command_ToSetWrist(subsystem_ShooterWrist shooterWrist, DoubleSupplier setpoint) {
  ...
  public void initialize() {
    m_Timer.start();
    m_Wrist.set_wrist(m_setpoint+Constants.ShooterWristConstants.note_to_wrist_offset);
  }
