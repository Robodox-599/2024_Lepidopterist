...
import frc.robot.subsystems.subsystem_Amper;
...
m_LED.set_stateCommand("armSpeaker"));
 }
 
 public static Command scoreAmp(subsystem_ShooterWheels m_flywheels,subsystem_Amper m_shamper){
  return Commands.parallel(m_flywheels.set_diverterCommand(2), m_shamper.amperCommand(true));
 }
 public static Command endAmp(subsystem_ShooterWheels m_flywheels, subsystem_Amper m_shamper){
  return Commands.parallel(m_flywheels.set_diverterCommand(0), m_shamper.amperCommand(false));
