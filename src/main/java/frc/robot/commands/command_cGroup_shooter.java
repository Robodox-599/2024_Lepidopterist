...
public static Command scoreAmp (subsystem_ShooterWheels m_flywheels,subsystem_ShooterWrist m_wrist){
return Commands.parallel(new command_ToSetWrist(m_wrist, ()->Constants.ShooterWristConstants.ampWrist),
new command_ToFlywheelSpeed(m_flywheels, ()-> Constants.ShooterFlywheelConstants.AmpSpeed));
}

public static Command sourceIntake(subsystem_ShooterWheels m_flywheels,subsystem_ShooterWrist m_wrist){
  return Commands.parallel(new command_ToSetWrist(m_wrist, ()->Constants.ShooterWristConstants.sourceWrist),
  new command_ToFlywheelSpeed(m_flywheels, ()-> Constants.ShooterFlywheelConstants.SourceSpeed));
  }
