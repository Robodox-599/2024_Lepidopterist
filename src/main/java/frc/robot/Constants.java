...
public final class Constants {
  ...
  public static class IndexerConstants {
    ...
    public static final int breakerPort2 = 2;
    public static final double IndexP = 0.1;
    public static final double IndexI = 0.0;
    public static final double IndexD = 0.0;
  ...
  public static class ShooterFlywheelConstants {
    ...
    public static class MotorConstants {
      public static final int flywheel1ID = 16;// fl drive
      public static final int flywheel2ID = 17;// fr drive
      public static final int feederID = 14;// fr angle
  ...
  public static class ShooterWristConstants {
    ...
    public static final double testSpeakerWrist = 3.5;
    public static final double minWrist = 0.0; // change
    public static final double maxWrist = 4; // change
    ...
    public static final double note_to_wrist_offset = 0;// make 23 later
    ...
    public static class MotorConstants {
      public static final int wristID = 15; // gear box dummy board motor is 40
