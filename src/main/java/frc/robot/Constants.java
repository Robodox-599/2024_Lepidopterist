  ...
  public static class FieldConstants { 
    ...
    public static Pose2d newPose(double x, double y, double theta){
      return new Pose2d(x, y, Rotation2d.fromDegrees(theta)).
            plus(new Transform2d(new Translation2d(-16.0 / 12.0 * UnitConstants.FEETRES_TO_METRES, 0.0).
                                        rotateBy(Rotation2d.fromDegrees(theta)), 
                                      Rotation2d.fromDegrees(0.0)));
    }

    public static final Pose2d[] subwooferPoses = new Pose2d[]{
    ...
    // public static final Translation2d redSubwooferAmp = new Translation2d(16.0778095, 6.349736).minus(new Translation2d(16.0, Rotation2d.fromDegrees(60.0)));
    // public static final Translation2d redSubwooferCenter = new Translation2d(15.215708, 5.5603685).minus(new Translation2d(16.0, Rotation2d.fromDegrees(0.0)));
    // public static final Translation2d redSubwooferSource = new Translation2d(15.7258562759, 4.5680435).minus(new Translation2d(16.0, Rotation2d.fromDegrees(-60.0)));
    // public static final Translation2d blueSubwooferSource = new Translation2d(0.4632355,4.771171).minus(new Translation2d(16.0, Rotation2d.fromDegrees(-120.0)));
    // public static final Translation2d blueSubwooferAmp = new Translation2d(0.4632485,6.34977).minus(new Translation2d(16.0, Rotation2d.fromDegrees(180.0)));
    // public static final Translation2d blueSubwooferCenter = new Translation2d(0.918944,5.5604715).minus(new Translation2d(16.0, Rotation2d.fromDegrees(120.0)));
...
//TODO: decide intake and indexer percent 
    ...
    public static final double intake_max_rpm = 5400 * IntakeConstants.kSpeakerIntakeSpeed;// TODO: test this
