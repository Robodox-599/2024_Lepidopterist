...
public final class Constants {
  ...
  public static class ShooterFlywheelConstants {
    ...
    public static final double differential = 5;
    public static final double feeder_runtime = 5;//sec
    public static final double diverter_speed_shooter = 0.5;
    public static final double diverter_speed_amper = -0.5;
    public static final double amperVoltage = 2;
    ...
    public static class MotorConstants {
      public static final int flywheel1ID = 17;//fl drive
      public static final int flywheel2ID = 18;//fr drive
      public static final int feederID = 9;//fr angle
      public static final int amperID = 0;
      public static final int diverterID = 6;
