...
public final class Constants {
  ...
  public static class ShooterFlywheelConstants {
    public static final double FlywheelMargin = 2;
    public static final double AmpSpeed = 60;
    public static final double SpeakerSpeed = 100;
    public static final double StowSpeed = 50;
    ...
    public static class MotorConstants {
      public static final int flywheel1ID = 0;//fl drive
      public static final int flywheel2ID = 3;//fr drive
      public static final int feederID = 4;//fr angle
  ...
  public static class LEDConstants {
    public static final int CANdle_ID = 1;//change
