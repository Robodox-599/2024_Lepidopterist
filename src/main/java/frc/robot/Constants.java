...
public final class Constants {
  public static class RobotConstants {
    public static Alliance robotColor = Alliance.Blue;
  }
  public static class FieldConstants { // created to make merging more painful (but keep this over the other one)
    // TODO: update (its in metres)
    public static final Translation3d blueSpeakerCenter = new Translation3d(1.1, 11.9, 4.321);
    public static final Translation3d redSpeakerCenter = new Translation3d(1.1, 11.9, 4.321);
    public static final Translation3d shooterOffset = new Translation3d(0, 0, 0); // offset from robot coords to shooter
                                                                                  // exit pt
  }
  ...
  public static class SwerveConstants {
    ...
    public static final double maxAngularVelocity = 360.0 * 1.25 * UnitConstants.DEG_TO_RAD / 4.0; // rad per sec
  ...
  public static final class FrontLeftModule {
    ...
    public static final double angleOffset = 0.981689 * 360.0;
  ...
  public static final class FrontRightModule {
    ...
    public static final double angleOffset = 0.890381 * 360.0;
    public static final double[] constants = { driveMotorID, angleMotorID, canCoderID, angleOffset };
  }
  ...
  public static final class BackLeftModule {
    ...
    public static final double angleOffset = 0.273193 * 360.0;
    public static final double[] constants = { driveMotorID, angleMotorID, canCoderID, angleOffset };
  }
  ...
  public static final class BackRightModule {
    ...
    public static final double angleOffset = 0.187744 * 360.0;
    public static final double[] constants = { driveMotorID, angleMotorID, canCoderID, angleOffset };
  }
