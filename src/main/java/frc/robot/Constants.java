...
public final class Constants {
  ...
  public static class ShooterFlywheelConstants {
    ...
    public static class MotorConstants {
      public static final int flywheel1ID = 9;//fl drive
      public static final int flywheel2ID = 41;//fr drive
      public static final int feederID = 2;//fr angle
  ...
  public static class ShooterWristConstants {
    ...
    public static class MotorConstants {
      public static final int wristID = 40; //gear box dummy board motor is 40
