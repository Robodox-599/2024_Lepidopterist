...
public final class Constants {
  ...
  public static class SwerveConstants{
    ...
    /*Swerve Angle Motor Feedforward*/
    public static final double angleKS = 0.098871;
    public static final double angleKV = 2.3627;
    public static final double angleKA = 0.021233;
  ...
  public static class AutoConstants{
    ...
    public static final double MaxAccelMetersPerSecondSquared = 1;
    public static final double MaxAngularSpeedRadiansPerSecond = 6;
    public static final double MaxAngularAccelRadiansPerSecondSquared = 3;
